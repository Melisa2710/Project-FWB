        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center"
                    ...
                    <div class="sidebar-brand-text mx-3">FoodApp</div>
                </a>
                ...
                @if (auth()->user()->role === 'customer')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.menus.index') }}">
                            <i class="fas fa-utensils"></i>
                            <span>Lihat Menu</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.orders.store') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.payments.create') }}">
                            <i class="fas fa-plus-circle"></i>
                            <span>Buat Pembayaran</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.deliveries.index') }}">
                            <i class="fas fa-fw fa-truck"></i>
                            <span>Lacak Pengiriman</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.feedback.index') }}">
